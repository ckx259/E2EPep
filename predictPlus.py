...
if __name__ == '__main__':
    ...
    parser.add_argument("-mdn", "--e2epep_model_dir_name", type=str, default='D1tst_E2EPep_model')
    ...
    parser.add_argument("-fmdn", "--e2epep_finetuned_model_dir_name", type=str, default='D1tst_E2EPep_finetuned_model')
    parser.add_argument("-mpdn", "--e2epepPlus_model_dir_name", type=str, default='D1tst_E2EPepPlus_model')
